...
def set_desired_power(drone, pitch, roll, yaw):
    """
    Set the power of the three axial directions
    :param drone: current drone entity/object
    :param pitch: power for pitch
    :param roll: power for roll
    :param yaw: power for yaw
    :return:
    """
...
def levelstate():
    """
    Establish level state for the drone in flight

    :return: True, if level state was established, False, if level state could not be established
    """
